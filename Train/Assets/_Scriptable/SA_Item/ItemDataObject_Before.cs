...
public class ItemDataObject_Before : ScriptableObject
{
    [SerializeField]
    private int num;
...
public enum Information_Item_Type_Before { 
    Equipment,
    Immediate,
    Weapon,
    Material,
...
public enum Information_Item_Box_Type_Before
{ 
    Item,
    Material,
    None,
...
public enum Information_Item_Rarity_Type_Before
{
    Common,
    Rare,
    Unique,
