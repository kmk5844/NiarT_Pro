...
public class ItemDataObject_Test : ScriptableObject
{
    [SerializeField]
    private int num;
    ...
    [SerializeField]
    private Information_Item_Type_Test item_type;
    public Information_Item_Type_Test Item_Type { get { return item_type; } }
    [SerializeField]
    private string item_information;
    public string Item_Information {  get { return item_information; } }

    [SerializeField]
    private Information_Item_Rarity_Type_Test item_rarity_type;
    public Information_Item_Rarity_Type_Test Item_Rarity_Type { get { return item_rarity_type; } }
    ...
    public void Auto_Item_Insert(
        int _num, string _item_id, string _item_name, Information_Item_Type_Test _item_type, string _item_information,
        Information_Item_Rarity_Type_Test _rarrity_type, string buy_sell_supply_flag,
...
public enum Information_Item_Type_Test { 
    Equipment,
    Immediate,
    Weapon,
    Box,
...
public enum Information_Item_Rarity_Type_Test
{
    Common,
    Rare,
    Unique,
