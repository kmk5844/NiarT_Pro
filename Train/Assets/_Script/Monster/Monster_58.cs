...
public class Monster_58 : Monster
{
    [SerializeField]
    Vector3 movement;
    int xPos;
    ...
    IEnumerator BulletFire()
    {
        ...
        {
            FireAtk.SetActive(true);
            FireAtk.GetComponent<MonsterBullet>().Get_MonsterBullet_Information(Bullet_Atk - (int)Item_Monster_Atk, 0f, 0f, 0);
