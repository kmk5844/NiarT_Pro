...
public class Monster_28 : Monster
{
    [SerializeField]
    Vector3 movement;
    int xPos;
    ...
    protected override void Start()
    {
        ...
        base.Start();
        MonsterDirector_Pos = new Vector2(transform.localPosition.x, transform.localPosition.y +0.4f);
        Spawn_Init_Pos =
    ...
    IEnumerator SpawnMonster()
    {
        ...
        //MonsterDirector_Pos = new Vector2(MonsterDirector_Pos.x, MonsterDirector.MinPos_Ground.y);
