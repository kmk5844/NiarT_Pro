...
/*        //용병 업그레이드 윈도우
    ...
    private void Player_Information_Text()
    {
        ...
        Player_Information[1].text = playerData.EX_Game_Data.Information_Player[playerNum].Player_Delay + "<color=red> - " + ((playerData.EX_Game_Data.Information_Player[playerNum].Player_Delay * playerData.Level_Player_AtkDelay) / 200).ToString("F3") + "</color>";
