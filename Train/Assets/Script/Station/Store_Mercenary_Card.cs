...
public class Store_Mercenary_Card : MonoBehaviour
{
    ...
    public GameObject Mercenary_Name;
    ...
    private void Start()
    {
        ...
        Mercenary_Name.GetComponent<TextMeshProUGUI>().text = mercenaryData.EX_Game_Data.Information_Mercenary[Mercenary_Num].Name
            + "\n" + mercenaryData.EX_Game_Data.Information_Mercenary[Mercenary_Num].Mercenary_Pride + "G";
    }
}
